define(function (require, exports, module) {
  ...
  Mesh.prototype = {
    ...
    isUsingTexCoords: function () {
      return this._renderData._shaderName === 'UV';
    },
    isTransparent: function () {
      return this._renderData._alpha < 0.99;
    },
    getShaderName: function () {
      return this._renderData._shaderName;
    },
    setShaderName: function (shaderName) {
      ...
      this._renderData._shaderName = shaderName;
      if (hasUV) {
    ...
    initRender: function () {
      this.setShaderName(this._renderData._shaderName);
